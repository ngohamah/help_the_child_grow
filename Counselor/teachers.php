<?php require('../database_credentials.php');
  ...
  Person.address, Person.tel, Person.primary_language, Teacher.principalID, Teacher.years_of_exp, Teacher.qualification FROM 
  Person,Teacher WHERE Person.personID=Teacher.teacherID;";
