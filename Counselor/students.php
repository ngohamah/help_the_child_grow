<?php require('../database_credentials.php');
  ...
  Person.address, Person.tel, Person.primary_language, Student.principalID, Student.counselorID, Student.major, Student.disability FROM 
  Person,Student WHERE Person.personID=Student.studentID;";
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">PrincipalID</th>
                                    <th scope="col">CounselorID</th>
