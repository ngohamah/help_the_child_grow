<?php require('../database_credentials.php');
  ...
  /*getting information for principals */
  $sql1 = "SELECT Person.fname, Person.lname, Person.dob, Person.gender, Person.address, 
  Person.tel, Person.primary_language, Principal.schoolID, Principal.schoolname, Principal.start_date, 
  Principal.years_of_exp, Principal.qualification FROM Person,Principal WHERE Person.personID=Principal.principalID; ";
?>
    ...
    <section>
        <div class="dashboard">
            ...
            <div class="display-dashboard">
                <form action="principals.php" method="post">
