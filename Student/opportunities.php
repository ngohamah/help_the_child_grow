                                ...
                                <?php
                                    ...
                                    if ($results->num_rows > 0) {
                                        ...
                                        ?><td colspan='2'> 
                                            ...
                                            <a href="opportunities.php?selectid=<?php echo $row['oppID'];?>" 
                    ...
                    <div class="container-fluid cdiv1 special-bottom-margin" >
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    //select query:
                                    $sql = "SELECT * FROM `StudentOpp` WHERE studentID='$pid'";
                                    ...
                                    if($results->num_rows>0){
                                        ...
                                        while($row = $results->fetch_assoc()) {
                                            ...
                                            ?><td colspan='2'> 
                                                <!-- getting specified record to be updated by id. -->
                                                <a href="opportunities.php?removeid=<?php echo $row['oppID'];?>" class='btn btn-danger'
                                    ...
                                    if(isset($_GET['selectid'])){
                                        ...
                                        $sql = "SELECT * FROM `StudentOpp` WHERE studentID=$pid AND oppID=$oppid";
                                        $results= $conn->query($sql);
                                        
                                        if($results->num_rows!=1){
                                            //no record exist, insert new selection
                                            $sql = "INSERT INTO `StudentOpp`(`studentID`, `oppID`) VALUES ($pid,$oppid)";
                                            if ($conn->query($sql) === TRUE) {
                                                echo "<p style='color:green; margin-left:60px;'>New opportunity added</p>";
                                            } else {
                                                echo "Error: " . $sql . "<br>" . $conn->error;
                                            }
                                        }else{
                                            echo "<p style='color:red; margin-left:60px;'>Opportunity already exist</p>";
                                        }
                                    }
                                    ...
                                    if(isset($_GET['removeid'])){
                                        ...
                                        $sql = "DELETE FROM `StudentOpp` WHERE studentID=$pid AND oppID=$oppid";

                                        if ($conn->query($sql) === TRUE) {
                                            echo "<p style='color:red; margin-left:60px;'>One Opportunity removed</p>";
                                        } else {
